...
class HarafBaharPage extends StatefulWidget {
  final GameResultModel? gameResultModel;

  const HarafBaharPage({Key? key, @required this.gameResultModel})
      : super(key: key);

  @override
  _HarafBaharPageState createState() => _HarafBaharPageState();
}

class _HarafBaharPageState extends State<HarafBaharPage> {
  var balance = "0".obs;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text("${widget.gameResultModel!.gameName}"),
          actions: [
                    ...
                    onPressed: () {
                      ...
                      n.forEach((i) {
                        if (i.controller.text.toString() != "") {
                          if (int.parse(i.controller.text.toString()) > 0) {
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                              child: Center(
                                            child: Text(
                                              "Date : ${timediff().day}-${timediff().month}-${timediff().year}",
                                              style: TextStyle(
                                                  color: Colors.white,
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 16),
