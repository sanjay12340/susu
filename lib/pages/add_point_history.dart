            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  ...
                  String sql =
                      "SELECT `id`, `user_id` as userId, `c_amount` as cAmount , `credit`, `debit`, `final_amount` as finalAmount , `date`, `created_at` as createdAt, `comment`, `uids` FROM `transaction`  WHERE comment LIKE '%add%' and" +
                          filter +
