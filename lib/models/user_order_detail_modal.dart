...
UserOrderDetailModal userOrderDetailModalFromJson(String str) => UserOrderDetailModal.fromJson(json.decode(str));

String userOrderDetailModalToJson(UserOrderDetailModal data) => json.encode(data.toJson());
...
class UserOrderDetailModal {
    ...
    factory UserOrderDetailModal.fromJson(Map<String, dynamic> json) => UserOrderDetailModal(
        status: json["status"],
        user: json["user"] == null ? null : User.fromJson(json["user"]),
        orderDetail: json["order_detail"] == null ? null : OrderDetail.fromJson(json["order_detail"]),
        orderReport: json["order_report"] == null ? [] : List<OrderReport>.from(json["order_report"]!.map((x) => OrderReport.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "order_report": orderReport == null ? [] : List<dynamic>.from(orderReport!.map((x) => x.toJson())),
    };
}
